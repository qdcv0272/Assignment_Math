 ...
 * ```
 */ export type ValidationRunModuleResult = Omit<RunModuleResultBase, 'codeFile'> & {
  reason: 'validation';
  /**
     * 발생한 유효성 검사 오류 그룹.
     */ errors: ErrorGroups;
};
export type RunModuleResult = SuccessRunModuleResult | AbortedRunModuleResult | ErrorRunModuleResult | ValidationRunModuleResult;
