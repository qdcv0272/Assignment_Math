...
import type { Block } from "../node/block.js";
import type { Rule } from "../prepare/parse/type.js";
import type { Token } from "../prepare/tokenize/token.js";
import type { YaksokSession } from "../session/session.js";
 ...
 */ export declare class CodeFile {
  ...
  private tokenized: any;
  private parsed: any;
  private functionDeclareRangesCache: any;
  private exportedRulesCache: any;
  public validationScopes: Map<Node, Scope>;
  public ranScope: Scope | null;
  public session: YaksokSession | null;
  public executionDelay: number | null;
  constructor(text: string, fileName: string | symbol);
  /**
     ...
     */ mount(session: YaksokSession): void;
  /**
  ...
  /**
     ...
     */ public get functionDeclareRanges(): ReturnType<typeof getFunctionDeclareRanges>;
  /**
  ...
  /**
     ...
     */ public run(): Promise<Scope>;
  public registerScope(scope: Scope, node: Node): void;
