...
import type { CodeFile } from "../type/code-file.js";
import type { RunnableObject } from "../value/function.js";
/**
 ...
 */ export declare class Scope {
  ...
  codeFile?: CodeFile;
  public functions: Map<string, RunnableObject>;
  public callStackDepth: number;
  private readonly allowFunctionOverride: any;
  constructor(config?: {
    parent?: Scope;
    codeFile?: CodeFile;
  ...
  /**
     ...
     */ setVariable(name: string, value: ValueType, tokens?: Token[]): void;
  /**
     * 현재 스코프에만 변수를 설정합니다.
     * 상위 스코프 탐색 없이 로컬 슬롯을 직접 갱신해야 하는 경우 사용합니다.
     */ setLocalVariable(name: string, value: ValueType, tokens?: Token[]): void;
  /**
  ...
  /**
     ...
     */ addFunctionObject(functionObject: RunnableObject): void;
  /**
  ...
  private emitVariableSetEvent: any;
  private emitVariableReadEvent: any;
}
