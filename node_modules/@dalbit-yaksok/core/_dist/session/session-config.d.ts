...
import type { Pause } from "../node/misc.js";
import type { Token } from "../prepare/tokenize/token.js";
import type { Position } from "../type/position.js";
import type { MachineReadableError } from "../error/render-error-string.js";
import type { VariableReadEvent, VariableSetEvent, WarningEvent } from "../type/events.js";
 ...
 */ export interface SessionConfig {
  ...
  /**
     ...
     */ stderr: (message: string, machineReadableError: MachineReadableError) => void;
  /**
     * 활성화할 기능 플래그
     */ flags: EnabledFlags;
  /**
  ...
  /**
     ...
     */ canRunNode: ((scope: Scope, node: Node) => Promise<boolean> | boolean) | null;
}
export type Events = {
  /**
     ...
     * @param end
     * @returns
     */ runningCode: (start: Position, end: Position, scope: Scope, tokens: Token[]) => void;
  pause: () => void;
  resume: () => void;
...
export type { WarningEvent } from "../type/events.js";
