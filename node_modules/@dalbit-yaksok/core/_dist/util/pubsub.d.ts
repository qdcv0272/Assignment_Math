 ...
 */ export declare class PubSub<Events extends {
  ...
  /**
     ...
     * ```
     */ public sub<EventName extends keyof Events>(event: EventName, listener: Events[EventName]): () => void;
  /**
     * 지정된 이벤트를 생성합니다.
     ...
     * ```
     */ public pub<EventName extends keyof Events>(event: EventName, args: Parameters<Events[EventName]>): void;
}
